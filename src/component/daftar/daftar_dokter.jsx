          ...
          <div className="daftar-inp">
            ...
            <form action="">
              ...
              <input
                ...
                name=""
                id=""
                placeholder="Masukkan Masukkan Nomor Handphone Anda"
              />
              <h4>Email</h4>
              <input
                type="text"
            ...
            <div className="syarat">
              <p>
                Dengan menekan <strong>Daftar</strong>, Anda setuju dengan semua{" "}
            ...
            <p>
              Anda sudah memiliki akun ? <a href="">Masuk disini</a>
            </p>
          </div>
        </div>
      </div>
