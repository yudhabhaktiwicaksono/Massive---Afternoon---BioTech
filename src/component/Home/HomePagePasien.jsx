  ...
  var unsplashZDjhwOUvTwIcon = document.getElementById("unsplashZDjhwOUvTwIcon");
    ...
    return(
      ...
      <div class="rectangle-parent">
        <div class="group-child"> <input type="search" placeholder="Search...." /> </div>
        <img
      ...
      <div class="group-parent">
        ...
        <div class="ellipse-parent">
          <img class="group-inner" alt="" src={pesan} /><img
            class="group-child2"
            alt=""
      ...
      <div class="rectangle-container">
        ...
        ><img
          class="pexels-antoni-shkraba-5215024-icon"
          alt=""
          src={foto1}
        />
      </div>
      <div class="homepage-pasien-inner">
        <div class="group-div">
          ...
          <img class="unsplashwnolnjo7ts8-icon" src={foto5} alt="" /><b
            class="yudha-bakti-wicaksono"
            >Yudha Bakti Wicaksono</b
          ><b class="your-profile">Your profile</b>
          <b class="b1">+6287734565543</b><b class="male-19">Male, 19</b
      ...
      <div class="homepage-pasien-child">
        <div class="group-div">
          ...
          <div class="group-child4"></div>
          <img
            class="unsplashwnolnjo7ts8-icon"
            alt=""
            src={foto5}
          ...
          <b class="b1">+6287734565543</b><b class="male-19">Male, 19</b
          ><b class="jawa-barat">Jawa Barat</b>
          <a href="" className="lihat-profil">Lihat Profil</a>
          <img class="vector-icon" alt="" src="public/vector.svg" /><img
            class="group-icon"
            alt=""
            src={foto4}
      ...
      <div class="group-parent1">
        <div class="rectangle-parent5">
          ...
          <b class="vital">Vital</b><b class="lab-reports">Lab Reports</b>
          <a href="" class="view-all">View all</a>
          <img class="vector-icon5" alt="" src="public/vector.svg" /><img
            class="group-icon"
            alt=""
            src={foto4}
          />
        ...
        <div class="temperature-parent">
          <b class="temperature">Temperature</b><b class="f">98.2 F</b
          ><img class="temperature-icon" alt="" src={suhu} />
        </div>
        <div class="tinggi-badan-parent">
          <b class="temperature">Tinggi Badan</b><b class="f">160 cm</b
          ><img class="temperature-icon" alt="" src={tb} />
        </div>
        <div class="berat-badan-parent">
          <b class="temperature">Berat Badan</b><b class="f">50 kg</b
          ><img class="temperature-icon" alt="" src={bb} />
        </div>
        <div class="detak-jantung-parent">
          <b class="temperature">Detak Jantung</b><b class="f">166 bpm</b
      ...
      <div class="homepage-pasien-inner4">
        <div class="rectangle-parent7">
          ...
          ><img class="vector-icon7" alt="" src="public/vector7.svg" /><img
            class="vector-icon8"
            alt=""
      ...
      <div class="line-chart">
        ...
        <img class="x-axis-grid-icon" alt="" src="public/xaxis-grid.svg" /><img
          class="x-axis-grid-icon1"
          alt=""
          src="public/xaxis-grid.svg"
        /><img
          class="x-axis-grid-icon2"
          alt=""
          src="public/xaxis-grid.svg"
        /><img
          class="x-axis-grid-icon3"
          alt=""
          src="public/xaxis-grid.svg"
        /><img
          class="x-axis-grid-icon4"
          alt=""
          src="public/xaxis-grid.svg"
        /><img
          class="y-axis-grid-icon"
          alt=""
          src="public/yaxis-grid.svg"
        /><img
          class="y-axis-grid-icon1"
          alt=""
          src="public/yaxis-grid.svg"
        /><img
          class="y-axis-grid-icon2"
          alt=""
          src="public/yaxis-grid.svg"
        /><img
          class="y-axis-grid-icon3"
          alt=""
          src="public/yaxis-grid.svg"
        /><img
          class="y-axis-grid-icon4"
          alt=""
          src="public/yaxis-grid.svg"
        /><img
          class="y-axis-grid-icon5"
          alt=""
          src="public/yaxis-grid.svg"
        /><img
          class="y-axis-grid-icon"
        ...
        <img class="line-icon" alt="" src={line} /><img
          class="line-icon1"
          alt=""
          src={line2}
        /><img class="marker-icon" alt="" src="public/marker.svg" /><img
          class="marker-icon1"
          alt=""
          src="public/marker1.svg"
        /><img class="marker-icon2" alt="" src="public/marker2.svg" /><img
          class="marker-icon3"
          alt=""
          src="public/marker3.svg"
        /><img class="marker-icon4" alt="" src="public/marker4.svg" /><img
          class="marker-icon5"
          alt=""
          src="public/marker5.svg"
        /><img class="marker-icon6" alt="" src="public/marker6.svg" /><img
          class="marker-icon7"
          alt=""
          src="public/marker7.svg"
        /><img class="marker-icon8" alt="" src="public/marker8.svg" /><img
          class="marker-icon9"
          alt=""
          src="public/marker9.svg"
        />
      </div>
